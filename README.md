...
index exists” from “an index exists but was refused”; only an `ENOENT`
filesystem result means absent. Permission, invalid-path and other I/O failures
are refused rather than treated as a first run.
